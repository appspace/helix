...
- Foreign-key diagram — auto-laid-out ERD for the whole schema, or for one table's dependencies (right-click a table → Dependencies); pan, zoom, drag boxes to rearrange, click a table to open it in a query tab
